...
public class MainActivity extends AppCompatActivity {
    ...
    private void offButtons(){
        ...
        viewButton.setBackgroundColor(Color.LTGRAY);
        deleteButton.setBackgroundColor(Color.LTGRAY);
    }
    private void onButtons(){
        viewButton.setEnabled(true);
        deleteButton.setEnabled(true);
        viewButton.setBackgroundColor(getResources().getColor(R.color.button));
        deleteButton.setBackgroundColor(getResources().getColor(R.color.button));
    }
}